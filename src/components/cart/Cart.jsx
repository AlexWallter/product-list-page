...
export const Cart = ()=> {
    ...
    const numOfItems = useOrderstore((state)=>state.numOfItems)
        ...
        <> 
            <div className="cart">
                <header className="cart__header">
                    <p className='bold-font big-font-sz'>your cart ({numOfItems})</p>
                </header>
                    {
                        totalOrder.length?(
                            <>
                                ...
                                <p className='semi-bold-font'>Order total</p><span className='bigger-font-sz bold-font'>${totalCost}</span>
                                </div>
                                <div className="cart__order--carbon semi-bold-font">
                                ...
                                <a className="cart__order--btn u-order-btn" onClick={()=>handleModal()}>Confirm Order</a>
                            </>
                        )
                        :(<>
